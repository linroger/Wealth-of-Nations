...
Risky debt (debt with a positive probability of bankruptcy) distorts capital budgeting decisions. It provides incentives to make tradeoffs between cash in __MASK_6_10__ and not in __MASK_6_11__ that differ from the ones that maximize the value of the firm.
...
Consider a borrower who needs to raise a large quantity of capital. All lenders and borrowers are risk neutral. The borrower has no capital and needs to raise 1 ( __MASK_3_7__ million).
...
Ii. The uninformed liquidity traders start out believing that the probability that __MASK_3_0__ is __MASK_3_1__ ( __MASK_3_2__ is also the probability that __MASK_3_3__ ).
...
For example,  if there are no informed traders the __MASK_6_19__ is zero. If there are nothing but informed traders,  there is no __MASK_6_20__ which allows the market maker to break even,  because he loses on all trades to informed.

# e.One Period Example

i. Absent a trade,  price of the stock would be __MASK_3_4__ because there is a 50-50 chance of being worth 1 or 0. If no informed traders existed,  this would be the price,  with no spread. This represents the "grand mean" average value of the stock.
...
If the buy is from a liquidity trader,  the stock is equally likely to be worth 0 as 1,  so the average profit from the trade is: ask __MASK_3_9__ .
...
If a sell order comes in,  and it is from an informed,  it must be that the private information is that the stock is worth 0 (otherwise the informed trader would buy) and the market maker will make a "profit" of: 0 - bid ( __MASK_3_11__ a loss of bid - 0).

If the sell is from a liquidity trader,  the stock is equally likely to be worth 0 as 1,  so the average profit from the trade is: __MASK_3_12__ - bid.
...
So,  at the beginning of the deal,  the investors as a whole enjoy Total Credit Enhancement ,  i.e. credit enhancement from over collateral iz ation plus credit enhancement from cash in the reserve account,  of __MASK_3_23__ of the APB
...
All tranches get exactly their scheduled interest and principal,  and the residual claimant gets __MASK_3_63__ of the __MASK_3_64__ 11\mathbf{M}\mathbf{M}__MASK_3_65__\__MASK_3_66__ of excess spread left over after covering defaults
...
So the servicer gets __MASK_3_94__ of the receivable s balance as a servicing fee,  and gets to keep any fees or other charges it extracts from borrowers. Note that Hyundai Motor Finance Company is the servicer.

# Class Note 12 – __MASK_6_95__

2 YHUYLHZ –

X What is __MASK_6_11__? What is its significance? X How are __MASK_6_12__ prices quoted? X Where do __MASK_6_13__ prices come from? X What are backup lines of credit,  and why do all __MASK_6_14__ issuers have them? X What is meant by the “early-exit mechanism” of the __MASK_6_15__ market? What has been the default experience of __MASK_6_16__ investors? X How do regulations affect the demand for different maturities? X What happened LQ''&ULVLV? X Alternative – Extendible Commercial Notes
...
The plunge in __MASK_6_23__ outstanding is due specifically to Asset-Backed Paper:
...
/Ŷ'ƐƵŵŵĂƌǇ͕' C W comes from three main categories of issuers
 ...
 -  Asset-Backed __MASK_6_29__ – issued by a special-purpose entity that holds financial assets such as mortgagebacked securities,  car loans,  etc.
...
This graph makes several points
 ...
 -  Asset-backed paper fell off a cliff o Down about __MASK_3_4__ from the __MASK_3_5__ peak,  and __MASK_3_6__ of this fall occurred in just 4 months starting in early August 2007,  with __MASK_3_7__ of that in just 3 weeks
...
What happened to these issuers was essentially a bank run. Firms that go to the __MASK_6_18__ market know they are exposed to bank-run risk. This is because when they issue CP,  they expect to repay it by issuing __MASK_6_19__ again,  i.e. by rolling it over. If they can’t roll it over,  they’ve got a problem. For this reason ,  a __MASK_6_20__ issuer generally has a committed bank facility at least as big as the amount of __MASK_6_21__ he has outstanding. This “backup line” plays exactly the role of the lender of last resort in the bank-run model: if the issuer needs extra cash to let investors out,  it doesn’t have to sell assets for bad prices,  it just needs to borrow the necessary cash from the bank . Knowing this,  a __MASK_6_22__ investor calculates that there’s no benefit from joining a ru n,  i.e. not rolling over his paper,  so he rolls over his paper and there’s no run.
...
Backup lines became widespread in the __MASK_6_1__ business after the Penn Central ZĂŝůƌŽĂĚ' default in 1970. Penn Central was a big issuer of CP,  and this was the first default in many years,  and the __MASK_6_2__ market crashed. The Fed eased this crash by providing liquidity to banks so issuers could borrow to pay their

 !__MASK_4_0__

In 1970 some __MASK_6_3__ issuers had backup lines,  and others did not. It was widely suspected during the Penn Central crisis that banks had an easier time borrowing at the discount window when they could show the Fed that they were borrowing more because issuers were taking down their lines.
...
Ever since the Penn Central crisis,  it has been essentially impossible for issuers to sell __MASK_6_4__ without arranging a backup line of credit. Investors worry that a company without backup credit will have a financial crisis,  which could precipitate default,  if the __MASK_6_5__ market panics.

X The thing to remember of backup lines of credit is that they are not credit enhancements. If a company goes bankrupt,  the bank is not going to pay off its CP. They are insurance not against the company going bad,  but against the __MASK_6_6__ market going bad. If the __MASK_6_7__ market panics,  a backup line allows an issuer to substitute bank borrowing for his __MASK_6_8__ borrowing,  and the __MASK_6_9__ investor gets out whole. X A backup line of credit is a __MASK_6_10__ issuer’s indirect access to the lender of last resort x Mercury Finance had backup lines,  but the banks cut off the lines when Mercury got into trouble (from fraudulent accounting).
...
A related strategy to this “internal liquidity” is what was sometimes called “extendible commercial notes”,  or just “extendible notes.” This was a way to issue something almost like __MASK_6_11__ without paying for backup liquidity. It worked like this:
 ...
 -  Here’s a typical schedule of interest rates for such paper: Rating % of __MASK_6_13__ Minimum Spread over LIBOR
...
Investors fled Canada's asset-backed __MASK_6_10__,  paralyzing the __MASK_3_1__ 40\cdot$ -billion market for debt that carried the highest credit ratings,  after losses from home loans to people with poor credit histories roiled global credit markets.
...
No __MASK_6_11__ borrower had failed to pay on time in two decades and Toronto-based DBRS gave the securities its top rating of R-1. The funds also had backup lines of credit from banks.

"You can get what the bank pays you,  which is not very much,  or you can put it in asset-backed __MASK_6_12__,  which have always been rated as high as you can get, " said Geoff Chapter,  a spokesman for Vancouver-based First Quantum Resources Minerals Ltd.
...
Starting in July,  growing defaults in U.S. home loans caused the cost of borrowing to increase for all but the most credit worthy companies. Rates on asset-backed __MASK_6_14__ soared.

Investors began demanding yields of about 6.03 per cent to own Coventree's __MASK_6_15__. On Aug. 13,  the company said it couldn't find enough buyers to refinance __MASK_3_3__ 950$ -million of short-term debt and its banks refused to provide emergency funds. Company spokesman Craig Armitage declined to comment.
...
In other words,  the investors in __MASK_6_34__ are big institutional investors with some short-term money. Selling __MASK_6_35__ is very much like selling __MASK_6_36__ – a short list of potential investors who buy in big lots.
...
Quotation of __MASK_6_38__ – Discount Rate

 !__MASK_4_26__

CP pays no coupons,  it just pays face value at maturity. If you buy __MASK_3_15__ 10\mathbf{M}__MASK_3_16__\__MASK_3_17__ on 4/18. It is therefore issued and traded at a discount,  and when traders quote prices to each other,  they talk in terms of discount rates ,  just like Tbills. So again if we call the face value __MASK_3_18__ ,  then number of days to maturity __MASK_3_19__ ,  and the discount rate __MASK_3_20__ ,  then the price __MASK_3_21__ is __MASK_2_0__

So for example,  if the discount rate for the __MASK_3_22__ 10\mathbf{M}__MASK_3_23__2.63\%$ ,  then the price is __MASK_2_1__
...
X __MASK_6_40__ issues can default,  and sometimes they do. X Biggest ever was \$457 MM of Pacific Gas & Electric paper in 2001 x Treasury bills are widely regarded as free of default risk

X __MASK_6_41__ is less liquid. The secondary market for __MASK_6_42__ is not as active as the secondary market for Treasury bills.

X On any given day,  an investor can buy __MASK_6_22__ maturing on any near-term date he wants x He can customize his __MASK_6_23__ investment to his liquidity needs,  so there is little chance he will bring it back to the market

X __MASK_6_24__ interest is subject to the income taxes of many states and municipalities,  but TB interest is not

As a result of the credit risk,  liquidity,  and taxation drawbacks,  __MASK_6_25__ trades at a discount relative to Tbills with the same maturity
...
Like other corporate debt,  __MASK_6_30__ is rated by the major agencies. Drexel Burnham sometimes issued unrated CP,  but now it is almost unheard-of. All rating agencies have four main categories,  which correspond to the categories of Moody’s:
...
Not only is __MASK_6_31__ always rated,  but almost all of the outstanding volume is highly-rated. As of 2/29/08 the Fed reports
...
X Value the investment at __MASK_3_16__ x Book __MASK_3_17__ of interest every day for those n days
...
Another influence on __MASK_6_39__ maturities is the Fed’s rule that banks can use __MASK_6_40__ as collateral for borrowing at the discount rule as long as its maturity is not greater than 90 days
...
X So the investment of money funds in Tier-2 paper is limited to __MASK_3_8__ of their total assets. This holds down demand for Tier-2 paper x This is part of why demand goes down abruptly when paper is downgraded
...
__MASK_6_44__ are fundamental to how institutions engaged in securities trading and dealing finance themselves. Notice that if I wanted to buy the security in our example for __MASK_3_35__ 1\mathbf{M}$ from someone,  say Albert,  I could do the following
...
I do the same repo as above,  except now the other side of the trade isn’t Bob ,  it’s JP Morgan,  and the interest rate isn’t __MASK_3_29__ ,  it’s __MASK_3_30__ Bob does the same repo as above,  except now the other side of the trade isn’t me,  it’s JP Morgan,  and the interest rate isn’t __MASK_3_31__ ,  it’s __MASK_3_32__ So now I’m paying __MASK_3_33__ more interest,  but what I get for that is more security: I am less worried that my counter party will default on its obligation to sell me the security back at the prearranged price And Bob is getting __MASK_3_34__ less interest,  but he also gets more security: he is less worried that his counter party will default on its obligation to buy the security back at the prearranged price JP Morgan makes the spread of __MASK_3_35__ in exchange for bearing our counter party risk
...
What has the Fed done about the repo market? They have introduced a program known as the Primary Dealer Credit Facility ,  whereby the Fed will loan money to dealers,  taking as collateral the kind of securities that would normally be used in repo transactions. These loans aren’t __MASK_6_10__ but they are similar. The total size of this program is about __MASK_3_2__ 20\mathrm{B}$ .
...
So if you had __MASK_3_0__ 10\mathrm{K}__MASK_3_1__19^{\mathrm{th}}__MASK_3_2__\__MASK_3_3__ was guaranteed by the Treasury Essentially,  this is complete deposit insurance for these deposits The program was extended to September __MASK_3_4__ . This program succeeded in stopping ' the run. New regulations of MMF were put into place,  but more are probably on the way. 3 ULPH'PRQH\'PDUNHW'IXQGV'H[SHULHQFHG'UXQV'DJDLQ'LQ'0 DUFK''DQG'JRW'D'QHZ' JRYHUQPHQW') HGHUDO'5 HVHUYH'OHQGLQJ'SURJUDP'WR'VWRS'LW
...
Suppose that the price at date 1 is __MASK_3_3__ ,  and that on date 2 with probability q it will fall to __MASK_3_4__ (due to a noise trade) and with probability 1-q it will rise to by 20 to __MASK_3_5__ __MASK_3_6__ (due to a news trade). On date 3 the bet will mature and as a result,  __MASK_3_7__ for sure.
...
Suppose that at date 1 there are PBA funds and your long-term fund. The PBA funds wait until date 2 to get in,  hold treasuries from dates 1 to 2,  and hold treasuries from 2 to 3 if the arbitrage opportunity is gone by then.
 - The two-period expected return of a PBA fund is : __MASK_2_8__
...
The problem arose when they lost so much money that they faced margin calls. For a large enough loss,  even __MASK_6_3__ had the equivalent of PBA,  leading to forced sales at the bottom. __MASK_6_4__ had locked in investor's old money. But once they had lost enough to face margin calls,  their ability to raise new capital to meet the calls without liquidating their positions was limited. Not only was there standard PBA uncertainty about __MASK_6_5__'s ability to continue to make excess returns at low risk,  but there was a bank run style collective action problem. Unless __MASK_6_6__ could attract enough capital to meet all near term margin calls,  it would be forced to get out at the bottom. Anticipating this,  they would be unable to raise smaller amounts of capital. Since the market thought it was likely that they would soon liquidate and push down the price,  the current price of their positions moved against them due to front running.
...
Table 3: A meltdown after the Russian default ,  if __MASK_6_16__ must liquidate immediately

 !__MASK_4_14__

The panic from the Russian crisis would make the price fall by 30 (from 80 to 50 on date 1) by itself. By forcing the __MASK_6_17__ to liquidate,  it makes the price fall by 50 (80 to 30). The losses force a liquidation,  in a way very similar to a bank run.

In practice,  __MASK_6_18__ was careful to get some advanced assurance from margin lenders not to force immediate margin calls. As a result,  they had some time to meet the calls. We can interpret this as meaning that they are not forced out at date 1,  but can wait until date 2 to sell. If the news trade were to arrive on date 2 (which happens with
...
Suppose that __MASK_6_20__ could delay liquidation until date 2,  and it could still buy 5 at date 1 to seek a profit. Then the prices after the Russian default would be those shown in table 4.

# Table 4: A delayed meltdown if __MASK_6_21__ can wait to liquidate

 !__MASK_4_15__

Let us compute the expected price change from date 1 to 2. With probability q,  there is a noise trade that forces it down to 15,  because __MASK_6_22__ is forced out. With probability __MASK_3_2__ ,  there is a news trade,  that pushes the price up to 75 (and then __MASK_6_23__ is not forced out). The expected price change is then: __MASK_2_0__
...
Similarly,  if demand is low for UST and the price falls below __MASK_3_13__ ,  UST holders can exchange their UST tokens at a ratio of 1:1 for LUNA – which is worth more because of their scarcity and so the user can bank another risk-free profit. (End of quote from CoinDesk. Com)
...
The second analogy is tranching claims into short-term “safe” debt (TerraUSD) and equity (Luna). First think of Luna as equity in the value added of Terra and Luna together. The value of the combination is much higher if TerraUSD is a stable coin than if it is predicted to blow up. Call the value if it persists as stable: VS. The value of TerraUSD coins at __MASK_3_2__ 1$ each is T.

There is a lower value of value of Terra and Luna together if Terra is not a stable coin. An example of a coin that is not a stable coin is Bitcoin. Call the value if TerraUSD is not a stable coin (is Unstable),  VU<VS,  the value if a stable coin. For example,  __MASK_3_3__ .

Case A (no run) Suppose everyone expects TerraUSD to survive,  be worth __MASK_3_4__ 1__MASK_3_5__\mathrm{T}{<}\mathrm{V}\mathrm{S}__MASK_3_6__\mathrm{VS-T}>0__MASK_3_7__\__MASK_3_8__ ,  but would have no reason to do so once the value of Terra is __MASK_3_9__ 1__MASK_3_10__\mathrm{T}{=}25__MASK_3_11__\mathrm{VS-T}=30{-}25=5$ .
...
TerraUSD plus Luna could be worth __MASK_3_17__ if everyone was sure it would be worth that amount. However,  the right to convert to equity at __MASK_3_18__ 1__MASK_3_19__\mathrm{VU}{=}10$ . To a first approximation,  this is what happened in May 2022. TerraUSD was a fake safe asset.
