...
or 0.0032. This is less than the 0.0062 that you obtain from exchanging your bondHere is the markdown conversion for the document you provided without altering any content:
...
Keep everything from example 1: going concern value of VGO=1, bankruptcy value of L=. The Bank is owed B= and the Public is owed P=1.6. The public is junior and long-term. If the public does not make a concession, we saw in example 1 that the bank will force bankruptcy, and the public will then get L−B=−=. Suppose that the public is offered the chance to exchange for a bond with face P'=1, and the bank agrees not to force bankruptcy if the exchange succeeds. Suppose that the offer succeeds if 99% of the bonds are exchanged. Let "f" denote the fraction of the total bond issue that you expect to be exchanged by other holders.

The key point in this example is to look at the case where the new bonds (with face P'=1) are junior to the old bonds with face P=1.6. The bank's claim of  remains senior to the public.

Suppose that you own 1% of the old bonds, with face value . Your return from tendering of holding out depends on whether you expect the exchange offer to succeed in keeping the firm out of bankruptcy.

1. Suppose that you expect the offer to succeed, for example because every other holder tenders, and f=. You choose between tendering and "holding out" by not tendering.

A. To determine what you get if you tender, do the following calculation. If you tender, then all are tendered. Your new bond is paid (1% of) 1 when the firm is worth 2, and worth (1% of) 1−= when the firm is worth 1 (this is because the bank has a senior claim on ). The expected value of this claim is (1% of) (1) + () = . 1% of  is .

B. If, instead, you hold out and refuse to tender the bond, the offer will still succeed (because only 99% is needed). Then your bond is senior to the public bonds that tender: you will get paid before those that tender when the firm is worth 1. The bank is first paid , leaving 1−=. This means you are paid the full face value of  if you hold out instead of exchanging. You receive  when the firm is worth 1 and when it is worth 2: as a holdout, you receive  with probability , an expected value of . This exceeds the  that you get from tendering your bond.
...
2. Consider the case where you expect the exchange offer to fail (less than 98% of bonds exchanged: f<). If the offer fails, the bank will force bankruptcy. The firm will then be worth L=. After the bank is paid its , there remains  to be divided among the public.

If you hold out, and so does everyone else, you get 1% of . If you hold out and anyone exchanges, you get more than 1% of , because the holdouts are senior and are paid first. If more than 93.75% exchange (f>), the holdouts (who are senior) get paid in full (then 1-f<, and 6.25% of 1.6 = ).
...
As before, suppose that you own 1% of the bonds, and you expect all of the other bonds to tender (f=). If you tender, all of the bonds are tendered, and you get 1% of 1−B=1−=, or . Your expected return from tendering is then (1% of) q2P' + q1(1−B) = (1% of) (1) + () = (1% of) . This is .

If you hold out, then those who tender are senior to you. When the firm is worth 1, the public as a whole gets 1−B=1−=. There are bonds with face value of (99% of) 1, senior to you, they are owed , but get only . Therefore, as a holdout you will get nothing when the firm is worth 1.

By holding out, you will get P=1.6 when the firm is worth 2, and nothing otherwise. Your expected payment from holding out is then (1% of) q1P = (1% of) (1.6), or . This is less than the  that you obtain from exchanging your bond. Therefore if you expect the offer to succeed, you exchange. A prophesy that the offer to exchange will succeed is self-fulfilling.
...
Now consider what happens when the offer is expected to fail (less than 98% of the bonds are tendered: f<). If the exchange offer is expected to fail (leading to bankruptcy), you will want to exchange. The reason follows. If you exchange you divide L−B (=−=) with the others who exchange (a positiveHere is the markdown version of your document without any content alteration:
...
Suppose that you own 1% of the old bonds, with face value . Your return from tendering or holding out depends on whether you expect the exchange offer to succeed in keeping the firm out of bankruptcy. 
...
Now consider what happens when the offer is expected to fail (less than 98% of the bonds are tendered: f<). If the exchange offer is expected to fail (leading to bankruptcy), you will want to exchange. The reason follows. If you exchange you divide L−B (=−=)Here is your document, converted into markdown format with the original content intact:
...
Now consider what happens when the offer is expected to fail (less than 98% of the bonds are tendered: f<). If the exchange offer is expected to fail (leading to bankruptcy), you will want to exchange. The reason follows. If you exchange you divide L−B (=−.Here is your document, formatted into markdown as per your instructions, with the content unaltered:
...
## Note 5A: Coercive Exchange Offers and Exit ConsHere is the document, formatted exactly as per your instructions without any alterations to the content:
...
Now consider what happens when the offer is expected to fail (less than 98% of the bonds are tendered: f<). If the exchange offer is expected to fail (leading to bankruptcy), you will want to exchange. The reason follows. If you exchange you divide L−B (=−=) with the others who exchange