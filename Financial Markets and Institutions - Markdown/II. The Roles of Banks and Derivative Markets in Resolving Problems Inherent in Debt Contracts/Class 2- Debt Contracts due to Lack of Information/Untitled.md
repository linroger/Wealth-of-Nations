...
- Monitoring of the exact value of the borrower's project costs 0.002 ($200). If there is a single lender lending his or her own funds, that lender would monitor because the cost, 0. O 02, is less than the saving from monitoring, .2.
