...
# Introduction to Fixed Income Securities
   ...
   [Teaching Note 6 Mortgage Backed Securities](Teaching Note 6 Mortgage Backed Securities.md)
   [Teaching Note 7 A Rundown On Continuous Time Models](Teaching Note 7 A Rundown On Continuous Time Models.md)
   [PSET I Fixed Income Asset Pricing](PSET I Fixed Income Asset Pricing.md)
...
![](Introduction To Fixed Income Securities-20240331084204167.png)

## THE NOTIONAL AMOUNT OF OVER-THE-COUNTER DERIVATIVES

   Panel A. Millions Of Us Dollars
![](Introduction To Fixed Income Securities-20240331084224576.png)
...
!![](Introduction To Fixed Income Securities-20240331084249962.png)

## U.S. TREASURY BILLS,  NOTES,  AND BONDS

![](Introduction To Fixed Income Securities-20240331084310756.png)
...
![|500](Introduction To Fixed Income Securities-20240331084530427.png)
![](Introduction To Fixed Income Securities-20240331084555484.png)
## YIELD CURVES
...
## REPURCHASE AGREEMENTS
   ...
   Outstanding
![](Introduction To Fixed Income Securities-20240331091908885.png)
...
![](Z. Clippings/Lecture Note 1 Introduction To Fixed Income Securities-20240415223856802.png)
...
## REVERSE REPO TRANSACTION
   ...
   ![](Z. Clippings/Lecture Note 1 Introduction To Fixed Income Securities-20240415224136376.png)
...
## THE RELATION BETWEEN FORWARD CURVE AND SPOT CURVE
   ...
   ![](Introduction To Fixed Income Securities-20240331091950722.png)
   ...
   - There is a large literature on the [Functional Forms](Lecture 10- Functional Forms.md) for the discount function
...
![](Teaching Note 1 Introduction To Fixed Income Securities-1.octet-stream)
   ![](Introduction To Fixed Income Securities-20240331152353486.png)
...
## INTRODUCTION
   ...
   5. Dramatic change in behavior of Treasury bonds
   	...
   	- Negative rates in many
## THE OUTSTANDING AMOUNT U.S. DEBT
![](Introduction To Fixed Income Securities-20240331084127851.png)
   (Source: SIFMA and FRED at Federal Reserve of St. Louis.)
## FEDERAL FUNDS AND U.S. TREASURY YIELDS
![](Introduction To Fixed Income Securities-20240331084204167.png)
## THE NOTIONAL AMOUNT OF OVER-THE-COUNTER DERIVATIVES
...
## COUPON BONDS
   - Suppose that the price of the bond is trading at par (100) but the right-hand side is 105.
   - Then an arbitrageur can buy the bond (pay 100) and sell the strips (each cash payments) for a total of 105,           thereby making $5 (million). Since there is perfect matching of cash flows in the future,           the trade is an arbitrage.
   - Incidentally,           notice that if t = 0 and Ti are exact semi-annual maturities,           that is T 1 =0.\1,           T 2 = 1,           T 3 = 1.5 etc.,           then we have 2 × Ti = i for every i = 1*,          ..,           n*,          
   And thus the formula reduces to
   $$P(0,          T_{n})=\sum_{i=1}^{n}\frac{c/2}{\left(1+r_{2}\left(0,          T_{i}\right)/2\right)^{i}}+\frac{100}{\left(1+r_{2}\left(0,          T_{n}\right)/2\right)^{n}}$$
## CONVENTIONS AND TERMINOLOGY
   - It is important to spend a few words on some market conventions and terminology.
...
![](Teaching Note 1 Introduction To Fixed Income Securities-1.octet-stream)
   ...
   - Clearly,           the fitted curve is much smoother (by construction).
   - An important difference arises when we look at forward rates
   -    ![](Introduction To Fixed Income Securities-20240331152522582.png)"
url: "
# Teaching Note 1 Introduction To Fixed Income Securities
# INTRODUCTION TO FIXED INCOME SECURITIES
   John Heaton
