---
title: "MARKET 'S RATE EXPECTATIONS AND FORWARD RATES UNDERSTANDING THE YIELD CURVE: PART 2"
aliases: ["MARKET 'S RATE EXPECTATIONS AND FORWARD RATES UNDERSTANDING THE YIELD CURVE: PART 2"]
linter-yaml-title-alias: "MARKET 'S RATE EXPECTATIONS AND FORWARD RATES UNDERSTANDING THE YIELD CURVE: PART 2"
---
...
10. Forward and Survey-Expected Yield Curve Steepening Six Months Ahead
11. Link Between Zeros' Rolling Yields and Break-Even Spot Rate Changes
...
The impact of rate expectations on today's yield curve shape is best isolated by assuming that the pure expectations hypothesis holds.
...
However, this is roughly what the pure expectations hypothesis (PEH)
...
8.01% in year two, while in the second case, it is expected to earn 8.01%
