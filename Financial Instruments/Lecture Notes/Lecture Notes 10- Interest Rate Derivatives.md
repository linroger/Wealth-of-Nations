---
aliases: [LECTURE NOTES 10 INTEREST RATE DERIVATIVES, LECTURE NOTES 10INTEREST RATE DERIVATIVES, Interest Rate Derivatives]
...
3. Interest Rate Trees
	...
	2. 3.2 Risk Neutral Pricing on Trees
	3. 3.3 A 3-Period Bond
4. The Ho Lee Model
	1. 4.1 Risk Neutral Trees
	2. 4.2 Calibration of Ho Lee Model
5. Using Risk Neutral Trees
...
2. Then, compute$θ(i)$recursively, as follows
