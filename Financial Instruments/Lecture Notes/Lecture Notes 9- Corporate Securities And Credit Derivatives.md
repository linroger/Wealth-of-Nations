...
1. The Merton Model
	...
	2. 1.2 Credit Spreads
	3. 1.3 Relative Pricing
	4. 1.4 Warrants
	5. 1.5 Conflict of Interests between Equity and Bond holders
...
- EXAMPLE
	...
	- Two strategies:
		...
		2. Enter into a CDS with, say, AIG Financial Products, to obtain insurance against Lehman defaulting.
			...
			2. It is the equivalent for credit markets to the now standard interest rate swaps that corporations use to manage assets and liabilities.
	1. Assume CDS spread is 400bp, then investor pays AIG$10 ×  ×  =$100, 000 each quarter until default
	2. If default occurs, AIG FP pays$10 mm in exchange of the defaulted bond (physicaldelivery).
	3. If it is cash settled, dealer quotes for recovery rate are obtained, and Lehman pays"notional minus recovery."
