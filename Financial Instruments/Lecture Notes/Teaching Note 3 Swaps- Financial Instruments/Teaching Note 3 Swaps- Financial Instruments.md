---
title: HEDGING WITH CURRENCY SWAPS
...
  1. US firm pays Bank 1 mil euros on every date$T =.5, 1, …, 2.5$;
...
- A FX swap is a contractual agreement between two counterparties to exchange prespecified amounts of moneys denominated in different currencies.
- For instance, the swap contract between the US firm and a bank may be specified as follows:
  1. US firm pays Bank 1,000,000 euros on every date$T =.5, 1, …, 2.5$;
  2. Bank pays US firm 1,000,000 x$K$, say 1.306 million dollars on the same dates.
...
3. Both strategies perfectly hedge the exposure, as the exchange rate risk is eliminated and both payoff profiles are known at 0.
...
1. Interest rate swaps
	...
	2. Plain vanilla IR swaps have floating rate given by LIBOR
2. Energy swaps
...
4. Total return swaps
	...
	2. E.g. one party may pay the total return of Apple stock and the other the total return of Microsoft stock.
-----------------------------------------------------------------------------------
