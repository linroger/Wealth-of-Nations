---
aliases:
- 'These lecture notes provide an introduction to mean-variance analysis and the capital
  asset pricing model  '
- 
- 
...
$E[R_i] = µ$ and $Var(R_i) = σ^2$ f   $or i = 1^*,  …,  n^*$. We also suppose $Cov (R_i,  R_j) = 0$ for all $i = j$. Let wi denote the fraction of wealth invested in the i th security at time t = 0. Note that we must have Pn i=1 wi = 1 for any portfolio. Consider now two portfolios:
