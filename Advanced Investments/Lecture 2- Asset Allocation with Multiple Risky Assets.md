...
__MASK_6_23__
We now extend our optimal __MASK_6_24__ framework to allow for multiple risky assets. This gets us close to the type of models that are used by asset managers of large portfolios to decide how much to allocate to different asset classes.
...
I use bold lowercase letters for vectors and bold uppercase letters for matrices. I use __MASK_3_6__ to denote a column vector with all elements equal to one and __MASK_3_7__ for the identity matrix (which has ones on its diagonals and zeros everywhere else). Letters or symbols that are not in boldface are scalars.

### 2.1 Risk and return at the portfolio level

Consider __MASK_3_8__ risky assets with an __MASK_3_9__ vector of returns __MASK_3_10__ and expected returns __MASK_3_11__. We will often look at excess returns

__MASK_2_0__

Very important for our __MASK_6_25__ analysis is the __MASK_3_12__ covariance matrix of returns

__MASK_2_1__

For analyzing portfolio risk and return,  we need to know a few rules on how the moments of portfolio returns,  e.g.,  mean and variance,  depend on moments of individual asset returns. Suppose we have a portfolio with __MASK_3_13__ assets and the weight of every asset (in terms of the proportion of the portfolio's market value accounted for by each asset) is collected in the __MASK_3_14__ portfolio weight vector __MASK_3_15__. Then the portfolio return is
...
We can calculate the variance from the __MASK_3_16__ covariance matrix of individual asset returns as

__MASK_2_4__

This last formula shows that all __MASK_3_17__ elements of the covariance matrix play a role in determining the portfolio return variance. This is important. The portfolio variance depends not only on how volatile individual asset returns are,  but also on how strongly they covary,  i.e.,  whether they tend to move together or not. Here is how this looks like in the __MASK_3_18__ case,  where __MASK_3_19__ denotes the correlation of the two asset returns and __MASK_3_20__ their covariance:

__MASK_2_5__

So if the portfolio has positive weight on both assets,  __MASK_3_21__ and __MASK_3_22__,  then,  due to the middle term in this expression,  the higher the correlation of the two asset returns,  the higher the portfolio return variance.
...
This tells us something important and very useful: The solution for __MASK_3_4__ does not depend on the level of risk aversion! All investors,  irrespective of their degree of risk aversion should therefore hold a risky asset portfolio with the same composition (as long as they have the same beliefs about __MASK_3_5__ and __MASK_3_6__ ). Risk preferences should only matter for how much of their wealth they allocate to the risky asset portfolio overall and to the risk-free asset. By scaling up or down the risky asset portion of their wealth,  investors can adjust the riskiness of their wealth portfolio. This is sufficient for getting a portfolio consistent with their risk preferences.
...
The risky asset portfolio with weights __MASK_3_7__ is the tangency portfolio that you already encountered in your introductory investments course. Let's denote with __MASK_3_8__ and __MASK_3_9__ the returns and excess returns of this tangency portfolio,  respectively.

To get some intuition for what the optimal portfolio solution does and how it depends on expected returns and correlations,  suppose we have __MASK_3_10__ and
...
for some constant __MASK_3_11__ that collects all the scalar factors.

Now let's think about some special cases. If the two assets' returns are uncorrelated,  __MASK_3_12__,  then optimal portfolio weights are proportional to their expected returns. Suppose __MASK_3_13__. Then the investor puts a higher share into asset 1 than into asset 2 . This should be intuitive. It makes sense to invest more in the higher-earning asset when the two assets are otherwise identical. But why not put everything into asset 1 (or even short asset 2 and invest more than $100/% of the risky asset portfolio into asset 1)? Diversification benefits! Having some of asset 2 in the portfolio,  but not too much,  can still be useful because it lowers the risk of the portfolio.

Now consider a case where __MASK_3_14__ is very close to 1 and again __MASK_3_15__. In this case,  the assets are,  in terms of risk,  almost perfect substitutes. As a consequence,  a long-short position,  going long in asset 1 ,  short in asset 2 ,  is optimal: it earns a positive expected returns __MASK_3_16__,  but it has almost no risk because the returns of the two assets are almost perfectly correlated.
...
We can see the risk contribution of assets to the overall portfolio by examining the portfolio variance in equation (2.5). Note from (2.8) that the expression __MASK_3_17__ in

__MASK_3_18__ is a vector of covariances,  so the pre-multiplication by __MASK_3_19__ forms a weighted sum of these covariances,  i.e.,
__MASK_2_3__

We have now decomposed the overall portfolio variance in the pieces that come from each asset. How much risk each asset brings to the portfolio is determined by how much of this asset is in the portfolio,    i.e.,    its portfolio weight,    times the risk contribution measured by the covariance __MASK_3_20__. For the same weight,    an asset that has a higher covariance with the portfolio return adds more risk to the portfolio.

Dividing by __MASK_3_7__ on both sides,    we can express the risk contributions as shares of total portfolio risk. We get

__MASK_2_0__

The systematic risk of asset __MASK_3_8__ is measured by

__MASK_2_1__

One important take-away at this point is that systematic risk is investor specific. How much an asset contributes in terms of risk to an existing portfolio depends on what else is in the portfolio,    which will typically differ across investors. If asset __MASK_3_9__ has a high return covariance with the other assets in the portfolio,    then __MASK_3_10__ will be high. If the other assets' returns don't covary much with asset __MASK_3_11__ 's returns,    then __MASK_3_12__ will be low.

Now let's assume the investor's portfolio is mean-variance optimal,    i.e.,    it has weights __MASK_3_13__ as in (2.18),    with the modification that I dropped the scalar constant that rescales the portfolio in (2.18) to have weights that add up to __MASK_3_14__\omega^{*}$ less messy.
...
where __MASK_3_15__ is the expected excess return of the mean-variance optimal portfolio. Dividing the vector covariances in (2.25) by the portfolio variance in (2.26),    we then get a vector of betas:
...
For an asset __MASK_3_16__,    therefore,  

__MASK_2_6__

which looks exactly like the relationship predicted by the Capital Asset Pricing Model (CAPM) that you encountered in your introductory investments course - just with one very important difference: in the CAPM,    __MASK_3_17__ would be the beta with respect to the market portfolio return and __MASK_3_18__ would be the expected excess return on the market portfolio. Here they are just the beta with respect to an investor's optimal portfolio,    which need not be the same as the market portfolio,    and __MASK_3_19__ is the expected excess return on the investor's portfolio,    not the market portfolio.

The condition (2.29) tells us that when the existing portfolio is mean-variance optimal,    then expected returns of all assets must have expected excess returns exactly proportional to their betas with respect to the portfolio return __MASK_3_20__. The beta of asset __MASK_3_21__ tells us how much risk we would add to the portfolio if we added more of this asset to the portfolio. This is what we call systematic risk. This systematic risk originates from covariance,    i.e.,    the degree to which the return of asset __MASK_3_22__ and the portfolio __MASK_3_23__ move together in the same direction.

Furthermore,    equation (2.29) tells us that if the portfolio with return __MASK_3_24__ is already optimal,    then there cannot be any asset out there that offers an expected return that is lower or higher than what equation (2.29) prescribes. Each asset's expected return must be exactly commensurate with the systematic risk __MASK_3_25__ that this asset brings to the portfolio so that no asset looks attractive enough to add more of it to the portfolio,    or unattractive enough to reduce its position.

Otherwise,    if we could find such an asset __MASK_3_5__ that violates condition (2.29),    we could improve our portfolio's Sharpe ratio by adding more of asset __MASK_3_6__ to the portfolio (if the expected return is higher than required) or taking some of it out,    and possibly shorting it (if the expected return is lower than required). For example,    if an asset __MASK_3_7__ has __MASK_3_8__,    it would make sense for the investor to take more of asset __MASK_3_9__ into the portfolio,    because this would contribute to a relatively small amount of portfolio risk,    but a relatively big expected excess return.

We can decompose the total risk of an asset into systematic and idiosyncratic components. Note that __MASK_3_10__ is an ordinary least squares (OLS) regression slope coefficient in a regression of __MASK_3_11__ on __MASK_3_12__. This means we can decompose __MASK_3_13__ as follows

__MASK_2_0__

where __MASK_3_14__. This decomposition shows that movements in __MASK_3_15__ are partly due to movements perfectly aligned with __MASK_3_16__ (systematic) and partly due to movements uncorrelated with __MASK_3_17__ (idiosyncratic). Taking the variance of the leftand right-hand sides,  

__MASK_2_1__

we have now broken the total risk of asset __MASK_3_18__,    into two components: Systematic risk,    __MASK_3_19__,    and idiosyncratic risk,    __MASK_3_20__.
...
Of course,    this reasoning based on (2.29) applies only to small changes to the portfolio at the margin. The change in portfolio risk from a small addition of asset __MASK_3_21__ to the portfolio depends approximately only on the asset's systematic risk because the idiosyncratic risk diversifies away in the portfolio. Yet,    if the investor were to add a lot of asset __MASK_3_22__ to the portfolio,    portfolio return variance and the covariance of portfolio return and asset __MASK_3_23__ 's return changes. Moreover,    some of the risk that was idiosyncratic now becomes systematic: The higher the allocation to asset __MASK_3_24__,    the higher becomes the correlation of __MASK_3_25__ and __MASK_3_26__. In the extreme case,    where there is so much of asset __MASK_3_27__ in the portfolio that __MASK_3_28__,    the __MASK_3_29__ component vanishes.

This illustrates that what an investor considers as systematic or idiosyncratic risk depends on her existing portfolio. Since __MASK_3_30__ depends on what's in the investor's existing portfolio,    __MASK_3_31__ will typically be different for different investors. Hence,    how investors perceive systematic risk of assets will also differ.

### 2.4 Maximum Sharpe ratio

We can also show that when the condition (2.29) holds,    and hence __MASK_3_32__ is truly the return on an optimal portfolio that cannot be improved any further,    then this optimal portfolio achieves the highest possible Sharpe Ratio of any portfolio that can be constructed from the available assets.

To see this,    start from (2.29),  

__MASK_2_2__

and let __MASK_3_33__ and let __MASK_3_34__ denote the correlation of __MASK_3_35__ and __MASK_3_36__. Since __MASK_3_37__,    it is true that
...
This tells us that the Sharpe ratio of any asset __MASK_3_38__ (or any combination of assets) cannot exceed the Sharpe ratio of the optimal portfolio. In other words,    the portfolio with weights __MASK_3_39__ that we constructed in (2.18) has the highest possible Sharpe ratio of any portfolio combining the same assets.

### 2.5 Market equilibrium

As we did in the previous lecture for a single risky asset,    we can again ask how the __MASK_6_6__ of an individual investor fits together with the choices of other investors in equilibrium where supply equals demand. Our market equilibrium analysis in the previous lecture can be interpreted as dealing with the demand and supply of risky assets as a whole class. Here we are now asking about the composition of risky asset portfolios: what sort of composition investors would like to have,    and how the market gets these desired portfolio weights in line with the supply of securities actually available. Because we are interested in this compositional question,    we now focus on the relative quantities of risky assets,    expressed as a proportion of the total market capitalization of risky assets that investors demand or that is available as supply.

Supply is then given by the weights of the market portfolio of risky assets. This is the portfolio in which the weight of each asset is equal to ratio of the asset's market capitalization (price times shares outstanding),    mcap __MASK_3_2__,    to the aggregate market capitalization of all risky assets:
...
But now we wonder whether we should perhaps chop each of these periods into __MASK_3_3__ smaller subperiods and measure returns at this higher frequency. We then have a total number

of periods of __MASK_3_4__. Based on our annualization formulas from last lecture,    the expected returns at this higher measurement frequency would be approximately __MASK_3_5__ times the annual average return,    i.e.,    __MASK_3_6__. The standard deviation would be __MASK_3_7__ times the standard deviation of annual returns,    i.e.,    __MASK_3_8__. Therefore,    the standard error of the higher-frequency estimate __MASK_3_9__ would be

__MASK_2_0__

This is __MASK_3_10__ times the standard error of annual returns. However,    as we discussed,    the magnitude of expected returns is also smaller by factor __MASK_3_11__. Hence,    the ratio of true expected return to standard error remains unchanged. It is invariant to the measurement frequency! So chopping the return measurement intervals into smaller pieces is not going to help us at all to get more precise estimates of expected returns. If we make the measurement intervals smaller,    the signal (true expected return) shrinks at the same rate as the standard error.

As a consequence,    if we annualize the higher-frequency estimate in order to get an apples-to-applies comparison,    i.e.,    we look at __MASK_3_12__,    then the standard error for this annualized estimate is simply __MASK_3_13__ s.e. __MASK_3_14__,    i.e.,    exactly the same as the standard error when we use annual returns!
...
The key is that this standard error depends on the variance,    while the standard error of the mean in (2.40) depends on the standard deviation. If we divide the return measurement periods into __MASK_3_15__ subperiods,    then this variance falls by a factor of __MASK_3_16__. The standard error of the higher-frequency estimate __MASK_3_17__ becomes

__MASK_2_2__

If we look at the ratio of the true variance,    which falls by factor of __MASK_3_18__ and the standard error,    which falls by a factor of __MASK_3_19__,    we see that the ratio rises by __MASK_3_20__. In other words,    the standard error falls relative to the true variance. This means we gain in precision!

If we annualize the higher-frequency variance estimate,    i.e.,    we look at __MASK_3_21__,    then the standard error for this annualized estimate is

__MASK_2_3__

which is smaller,    by factor __MASK_3_22__,    than the standard error when we use annual returns. The same factor applies to covariances as well,    but we are not going to show this explicitly.

 !__MASK_4_24__

Figure 2.3: Distribution of annualized mean estimates when returns are measured at different measurement frequencies

Figures 2.3 and 2.4 illustrate this with simulations. I simulate __MASK_3_23__ daily returns by drawing from a normal distribution such that the annualized returns (assuming 250 trading days per year) have mean 0.05 and standard deviation 0.20 . I calculate the mean and standard deviation of these daily returns. Then I aggregate the returns to annual returns by summing the daily returns within 250 -day windows (if I do it by
...
properly compounding the daily returns,    the results are very similar). I calculate the mean and standard deviation of these annual returns. Then I repeat this 1,    000 times each with a new random draw of a daily return series of length __MASK_3_0__.

Figures 2.3 shows that the distribution of the mean of annual returns and distribution of the annualized mean estimated from daily returns (i.e.g,    daily return mean times 250) is basically identical,    as expected based on our earlier standard error calculations. In contrast,    Figure 2.4 shows that the distribution of annualized standard deviations estimated from daily returns (i.e.,    daily return standard deviation times __MASK_3_1__ ) is far smaller than the standard deviation of annual returns. The annualized standard deviations estimated from daily returns are much closer to the true standard deviation of 0.20. In other words,    these estimates are much more precise.

This is potentially extremely useful. The covariance matrix __MASK_3_2__ is an important input into the mean-variance optimal portfolio formula. If it is estimated with too much error,    the error may render the estimated portfolio weights useless. This is,    in fact,    one of the major problems that practical applications of portfolio optimization struggle with and where clever improvements can make a difference. One first step is to do what our analysis above suggests: Make the estimate of __MASK_3_3__ more precise by using higher-frequency
...
[^6]Non-synchronicity effects are another microstructure phenomenon that will distort covariance estimates constructed from transaction prices at very high frequency. Suppose you have two assets: Asset __MASK_3_2__ which is very liquid and usually trades every microsecond,    and asset __MASK_3_3__ which is very illiquid and trades only about once per hour. If we go to very high frequency - say,    5 minute returns - to estimate covariances,    it will happen very often that there is a piece of news that affects the true value of both assets,    but only the price of liquid asset __MASK_3_4__ responds immediately,    while it may often take another hour or so until the price of asset __MASK_3_5__ adjusts. But this stale price of asset __MASK_3_6__ that is recorded in a returns data file is not a true price. If someone actually tried to trade,    the price would adjust. It just didn't because it happened to be the case that nobody wanted to trade. With such non-synchronicity of prices,    it may seem,    based on 5 minute return data that the covariance of the returns of asset __MASK_3_7__ and __MASK_3_8__ is really low,    when in fact it is much higher. In contrast,    covariances estimated from daily returns in this example would have virtually no distortion from non-synchronicity and would reveal a higher covariance.
...
I now use a plug-in approach where we simply replace the vector __MASK_3_9__ with the mean excess returns estimates from Table 2.1,    which I label __MASK_3_10__,    and the covariance matrix __MASK_3_11__ with the

estimated covariance matrix from Table 2.1 (recall that a covariance is the product of the two standard deviations of the pair of asset returns and their correlation),    which I label __MASK_3_12__. I then calculate
...
Figure 2.5 presents the result. The bars in this figure show the elements of the portfolio weight vector __MASK_3_13__. This result may be somewhat surprising. The portfolio is mostly a combination of long positions in government bonds (U.S. Treasury and international) and domestic value stocks,    as well as a short position in international stocks. Other asset classes only play a minor role.
...
Figure 2.7 shows the results. In the latest decade,    the weights are somewhat stable and not too extreme. But in the first decade,    they take extreme values: In the early years we see weights of more than $400/% in __MASK_6_6__ and a roughly similarly sized
...
The estimation approach we have discussed so far starts from a viewpoint of complete ignorance about __MASK_3_0__ and __MASK_3_1__. We proceeded as if,    before looking at historical data,    we basically have no idea whatsoever what the values of expected returns,    variances,    and covariances are likely to be. And then we just set __MASK_3_2__ and __MASK_3_3__ to whatever the data tells us the estimates are.

This doesn't seem quite right. Surely we would think that an expected excess return of,    say,    the domestic stock market in the vicinity of,    say,    __MASK_3_4__100/% ? It would not make economic sense that expected returns are so high,    as people would have to have crazily high levels of risk aversion for stocks to offer such high rates of expected return. Based on a priori considerations,    before looking at any data,    we would say that such high expected returns are totally implausible. Yet,    if we take the sample average return as the only piece of information about the expected return,    we are not making any use of such prior knowledge that we may have. This prior knowledge may be vague,    but as we will see,    it can still be useful to obtain better estimates of return moments.

The Bayesian branch of statistics offers tools that allow use to describe mathematically how prior knowledge expressed as a __MASK_6_7__,    the prior distribution,    can be combined with evidence from data to obtain a posterior distribution that reflects the combined information from the prior and the data. For our purposes here,    we don't have to work through all that math required for working with the full prior and posterior __MASK_6_8__s. For practical purposes,    we can get quite far by just using a heuristic approach that captures the essence of the Bayesian method for the purpose of choosing portfolios.

Let's start with the prior beliefs. Suppose we think,    a priori,    that a reasonable number for expected excess returns of the risky assets under consideration is __MASK_3_4__\boldsymbol{\mu}_{0}__MASK_3_5__\boldsymbol{\mu}$ are normally distributed) then tells us that our posterior mean is

__MASK_2_0__

i.e.,    it's a weighted average of sample average excess returns of the assets and the prior mean. How much weight __MASK_3_6__ we would optimally put on the information coming from the observed data,    __MASK_3_7__ vs. the weight __MASK_3_8__ on the prior mean depends on: (i) how informative the data is (higher __MASK_3_9__ if the sample is larger and returns are less volatile); (ii) the precision of our prior beliefs that __MASK_3_10__ is in the vicinity of __MASK_3_11__ (lower __MASK_3_12__ if our prior beliefs are more precise).

But how do we come up with __MASK_3_13__ ? We could put in a number that seems reasonable. But is there perhaps a better approach,    one in which we could still let data influence our view?
...
implausible that they differ from each other by huge amounts. So if it happens to be the case that the sample averages of returns of asset classes differ a lot,    it's likely at least partly due to estimation error. To express this view that expected excess returns can't be too different in a prior belief we could say that the __MASK_3_14__ elements of __MASK_3_15__ are drawn from a distribution that is centered around the same mean __MASK_3_16__ for all __MASK_3_17__ assets,    with some variance around this mean. In other words,    we can write the prior mean vector as __MASK_3_18__.

Our posterior mean now becomes

__MASK_2_1__

The posterior mean of the asset returns is now pulled towards the common prior mean __MASK_3_19__. We call this shrinking towards __MASK_3_20__ and __MASK_3_21__ is a shrinkage estimator.

Now to the final step: What would be a good way to find a plausible value for this common mean? Rather than specifying __MASK_3_22__ purely based on a priori reasoning,    as a truly Bayesian approach demands,    we will use an approach that backs it out from observable data. This approach is known as an empirical Bayes approach.

Given that all assets share the same prior mean,    and realizations of returns are basically all random deviations from this prior mean (with two components,    first,    the deviation of individual __MASK_3_23__ from __MASK_3_24__ and then deviations of realized excess returns from the individual asset specific mean __MASK_3_25__ ),    a natural approach is to simply average,    across assets,    the time series averages of returns,    i.e.,    use

__MASK_2_2__

as an estimator of __MASK_3_26__. And then we plug it into the posterior mean equation in place of __MASK_3_27__ :

__MASK_2_3__

Now the posterior mean is pulling the estimates away from the individual-asset timeseries averages in __MASK_3_28__ toward the the cross-asset average of these time-series averages,    __MASK_3_29__.

Now let's refine this a little. For many assets,    it might not be all that plausible that the true elements of __MASK_3_30__ are drawn from distributions with a common mean __MASK_3_31__ because the assets differ substantially in their levels of risk. For example,    think of a portfolio of long-term U.S. Treasury bonds and a broad stock market portfolio. It does not seem plausible,    a priori,    that the lower-risk Treasury bond portfolio would earn the same expected return as a broad stock portfolio. For this reason,    it may be better to work with risk-adjusted measures of expected returns,    such as the Sharpe Ratio
...
can't stray too far from each other. In other words,    they are drawn from a distribution that is centered around the same mean __MASK_3_4__ for all __MASK_3_5__ assets,    with some random variation around __MASK_3_6__ for each asset. Following this view,    we then shrink estimated asset class Sharpe ratios __MASK_3_7__ toward their common mean rather than shrinking the mean returns. If we have a value for this __MASK_3_8__,    we can then get posterior Sharpe Ratios for the individual assets as

__MASK_2_1__

And as we discussed above for shrinking means,    we can use an empirical Bayes approach by replacing __MASK_3_9__ with the cross-sectional mean of the assets' estimated Sharpe ratios,    __MASK_3_10__ :
...
which we can plug into the optimal __MASK_6_23__ formula.

So far so good,    but how can all this be useful if we don't know __MASK_3_11__ ? We could be pick some value for __MASK_3_12__ and hope that it is somewhat plausible. We would want shrinkage to be weak enough to allow Sharpe ratios to vary across asset classes in ranges that seem plausible,    but strong enough to make it very unlikely that we get __MASK_3_13__ that take extreme values like,    say,    __MASK_3_14__. We will get to this soon.

But before we get there,    let's first look at covariance matrix estimation. We can employ similar shrinkage ideas in covariance matrix estimation. If we are trying to find an optimal portfolio with many assets,    it is crucial to bring in prior information to discipline the covariance matrix. With __MASK_3_15__ assets,    the covariance matrix has __MASK_3_16__ elements. The covariance matrix is symmetric,    where each covariance shows up twice above and below the diagonal,    but this still leaves __MASK_3_17__ parameters to estimate. For example,    with just 10 assets,    we already have __MASK_3_18__ parameters to estimate. The more parameters there are in the covariance matrix,    the more likely it is that estimation error generates problems.

The fact that we have to invert the covariance matrix in the optimal portfolio formula can hugely magnify estimation errors. We can get an idea of where the problem comes from by looking first at the case of only one asset. Here __MASK_3_19__ is just the estimated variance of a single asset return __MASK_3_20__. If estimation error pushes __MASK_3_21__ close to zero,    the inverse,    which is here just __MASK_3_22__,    explodes toward infinity. Non-invertibility of a covariance matrix is sort of like this. The difference to the single asset case is that with multiple assets,    the existence of any portfolio of assets (which is a linear combination of individual asset returns) with close to zero variance makes the covariance matrix blow up. The more assets there are,    the easier it is to find such portfolios where,    by chance,    a combination of estimation errors results in a portfolio that seemingly has close to zero variance in the sample that we are using to estimate the covariance matrix.
...
where all the correlations take the same value __MASK_3_11__. Using __MASK_3_12__ to denote the matrix of correlations estimated from the data,    our posterior estimate of the correlation matrix becomes
...
We then replace __MASK_3_1__ in the prior correlation matrix __MASK_3_2__ with this estimate __MASK_3_3__.

Now we have to tackle the remaining problem of how to estimate __MASK_3_4__. We can use an approach known as cross-validation. Cross-validation is a powerful idea that appears in lots of places in applied statistics and data science,    including many machine learning applications. The idea is that we can use historical data on returns to evaluate which value of __MASK_3_5__ would have led us to construct the best portfolios in the past,    where with "best" we mean that this value leads to the best out-of-sample portfolio performance. In this approach,    we basically imagine that we had constructed Sharpe Ratio estimates as in (2.53),    and portfolios based on these estimates,    in the past and we look for the value of __MASK_3_6__ that would have given us the best out-of-sample performance in the past.
...
Estimate __MASK_3_7__ as in (2.54) and __MASK_3_8__ as in (2.59) using data from beginning of 1980 to end of 1999 and for different values from __MASK_3_9__ (total shrinkage) to __MASK_3_10__ (no shrinkage).

For each of these __MASK_3_11__ and __MASK_3_12__ combinations for a value of __MASK_3_13__,    I calculate the optimal risky asset portfolio weights as in (2.18).

I then apply these weights to returns on the nine asset classes in January 2000 to calculate the out-of-sample portfolio return in January 2000,    i.e.,    in the month following the end of the estimation window. Again I do this for every value of __MASK_3_14__.

Then I move the estimation window in step 1 forward by one month to beginning of February 1980 to end of January 2000. Then I repeat steps 1 to 3 and I get an out-of-sample portfolio return in February 2020 for each value of __MASK_3_15__. I keep repeating until I have reached the portfolio return in December 2022.

Now I have several time-series of portfolio excess returns,    one for each __MASK_3_16__. I calculate the Sharpe ratio from these portfolio excess returns.

 !__MASK_4_21__

Figure 2.8: Out-of-sample Sharpe Ratios for different values of the shrinkage parameter __MASK_3_17__ and different lengths of the backward-looking estimation window

I then redo the whole procedure with a different estimation window sizes of 10 years and 5 years in addition to the 20-year window. Figure 2.8 shows the results. For each of the estimation window lengths,    it shows how the Sharpe ratio of the portfolio changes with __MASK_3_18__. There are a few things to note.

First,    when we use 20 years of data,    shrinkage doesn't have much of an effect. The Sharpe ratio is more or less insensitive to the value of __MASK_3_19__. Shrinkage is apparently not really needed to get better estimates,    but imposing lots of shrinkage also doesn't hurt. (Just to be clear,    this is obviously not a general conclusion that is always valid everywhere. It could well be the case that with a different set of asset classes,    or with estimates from different time periods,    there is substantial sensitivity of the out-of-sample Sharpe ratio to __MASK_3_20__ with 20-year estimation windows).

Second,    if we wish to use shorter estimation windows (perhaps because we think that expected returns and covariances may have changed too much over long periods of time),    shrinkage is important. With 5 -year estimation windows and no shrinkage at all (i.e.,    __MASK_3_4__ at the right-hand side of the plot) the Sharpe ratio is around zero. In other words,    the portfolio optimization has become useless. In contrast,    with __MASK_3_5__,    and hence extreme shrinkage,    the 5-year estimation window approach produces Sharpe ratios that are close to the highest possible Sharpe ratios for the 10-year and 20-year estimation windows.

As it turns out,    this extreme shrinkage approach with __MASK_3_6__ actually leads to an __MASK_6_24__ strategy that has become quite popular in the past decade or two.

### 2.9 Extreme forms of shrinkage: Risk parity and __MASK_3_7__

Let's examine in more detail the extreme shrinkage portfolio that results when we set __MASK_3_8__ in estimating __MASK_3_9__ as in (2.54),    i.e.,    with shrinkage towards a equal Sharpe ratios,    and __MASK_3_10__ as in (2.59).

In this case,    the covariance matrix estimate uses the empirically estimated standard deviations,    while the correlations are all shrunk completely to the equicorrelation matrix __MASK_3_11__ :

__MASK_2_0__

Before we plug this into the optimal portfolio formula,    it's useful to note that __MASK_3_12__ __MASK_3_13__.

With __MASK_3_14__,    the Sharpe ratios of all asset classes are completely shrunk to their common mean __MASK_3_15__ and so the expected excess return estimates implied by these identical Sharpe ratios are

__MASK_2_1__

The optimal portfolio weight formula (2.18) tells us that portfolio weights are proportional to __MASK_3_16__. In this case here,  

__MASK_2_2__

(The last equality holds because the inverse of the equicorrelation matrix has the property,    just like the equicorrelation matrix does,    that the sum of the elements in each row or column is the same. This means that when we multiply __MASK_3_17__ with __MASK_3_18__ we get,    as a result,    a vector with equal elements that is proportional to __MASK_3_19__.) So,    optimal portfolio weights will be proportional to __MASK_3_20__. And since __MASK_3_21__ is diagonal,    we get

__MASK_2_3__

Let's examine the weights in (2.64). They only depend on individual asset class risk as measured by standard deviations. Estimates of mean returns or correlations have completely disappeared from the optimal portfolio weight formula. This is a consequence of the extreme shrinkage we have imposed. These are the weights underlying the portfolios at the very left side of Figure 2.8 for __MASK_3_22__. Basically,    this strategy expresses extreme distrust in empirical estimates of correlations and mean returns,    but considers standard deviation estimates as reliable.

Among investment practitioners,    the approach to portfolio allocation embodied in the weights in (2.64) is known as risk parity. It was pioneered by the hedge fund firm Bridgewater Associates in their All Weather Fund in the mid-1990s. The high Sharpe ratios for __MASK_3_23__ in Figure 2.8 tells us that this approach has done well in the past few decades,    which may explain why it became popular.
...
The risk contributions of each asset class per unit of weight are represented by the covariances __MASK_3_0__,    and their total risk contribution to the portfolio by this covariance times the portfolio weight. With risk-parity weights proportional to __MASK_3_1__ and the assumption that the correlation matrix of the asset classes is an equicorrelation matrix,    one can show that __MASK_3_2__ is then the same for each asset class-i.e.,    each asset

class accounts for the same share of total portfolio risk. __MASK_3_3__ This is what people mean when they say that a risk parity strategy then gives each asset class an equal risk budget for its contribution to portfolio risk (and keep in mind that this statement is true only if the equicorrelation assumption holds).
...
Now consider an even more extreme form of distrust in the data. Suppose we don't believe that historical data on standard deviations are useful for forecasting future volatility. We therefore feel that we can't distinguish between asset risk levels and we impose extreme shrinkage not only on mean returns and correlations,    but also standard deviations: we assume they are the same __MASK_3_1__. Then the portfolio weights for all asset classes are exactly equal and the risky asset portfolio weights are

__MASK_2_0__

where __MASK_3_2__ is the number of asset classes. This portfolio formation strategy is called,    sensibly,    a __MASK_3_3__ strategy. It uses no inputs about expected returns and risks whatsoever.

 !__MASK_4_12__

Figure 2.10: Out-of-sample Sharpe Ratios of different portfolio strategies (10 years of data to estimate return moments)

This may seem like an extremely unsophisticated __MASK_6_13__ strategy. And in some sense it is. But look at Figure 2.10! The Figure shows the out-of-sample Sharpe ratios of four strategies: (i) no shrinkage at all - this is the portfolio of the 10-year line

for __MASK_3_4__ in Figure 2.8; (ii) optimal shrinkage of __MASK_3_5__ based on the maximum of the line for 10-year estimation windows in Figure 2.8; (iii) risk parity; (iv) __MASK_3_6__.

Surprisingly,    __MASK_3_7__ does quite well! Not as good as optimal shrinkage and risk parity,    but still much better than in the no-shrinkage case. There is actually a fairly large body of research at this point showing that the __MASK_3_8__ strategy of forming a diversified portfolio does quite well in a number of settings.

As for the risk parity approach,    the selection of the menu of assets is very important. By adding lots of very similar,    highly correlated asset classes,    a __MASK_3_9__ portfolio would become poorly diversified and its Sharpe ratio would suffer. Part of the success of __MASK_3_10__ in our analysis here comes from the fact that we started with a good selection of asset classes that span a lot of different types of risks.

But one conclusion that we can tentatively draw from the success of __MASK_3_11__ in this exercise is that our inputs to the optimal portfolio weight formula are perhaps not good enough yet. For example,    just plugging in historical estimates of mean excess returns from the past 10 years may be a poor way of forecasting future excess returns.
