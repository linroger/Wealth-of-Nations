...
| ::: {  .cell execution_count=105} ``` {. Python .cell-code} second_order_derivative = sp.Simplify (first_order_derivative.Diff (y)) print (‘Second order derivative:’) display (second_order_derivative) |
