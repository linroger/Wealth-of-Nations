...
- Why does the term structure exist?  
  - Liquidity preference    o   Expectations theory  o   Risk  o   Inflation (Deflation) risk  
...
- Limitations  
  - Ignores cash flows after payback date    o   Equally weights all cash flows  §   Less of an issue in low/no inflation countries  
# Payback Period  
...
- Many companies simply ignore  
  - Assumes inflation low and affects all inputs and outputs  similarly    o   Most problematic when a specific input increases in cost  or output decreases in price relative to others  
...
- Major departures  
  - Taxes    o   Transaction Costs  o   Financial Distress and Bankruptcy  o   Conflicts between creditors and shareholders  
# Taxes  
