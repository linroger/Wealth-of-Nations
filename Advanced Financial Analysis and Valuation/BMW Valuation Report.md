---
title: '<A NAME="_HEADING=H.8FAKY1RZMRWL"></A>CONTENT'
aliases: ['<A NAME="_HEADING=H.8FAKY1RZMRWL"></A>CONTENT']
linter-yaml-title-alias: '<A NAME="_HEADING=H.8FAKY1RZMRWL"></A>CONTENT'
---
...
# <A NAME="_HEADING=H.8FAKY1RZMRWL"></A>CONTENT

[**Content	3**](#_heading=h.8faky1rzmrwl)**
[**1. Overall Description	4**](#_heading=h.allqtzi3qfaa)
[**2. Business Segments	4**](#_heading=h.blqagbryjhgd)
[2.1 Automotive	4](#_heading=h.1hs2namco7tt)
...
[7.1 Competitive advantages:	9](#_heading=h.6fl2c7phn3re)
[7.2 Competitive disadvantages:	9](#_heading=h.8tjvio4uc068)
[**8. Share Buyback Program and Dividend Policy	10**](#_heading=h.uqa8mukvm16w)
[**9. Financial performance and forecast	10**](#_heading=h.1bvwl0xsisug)
...
[9.4 Multiples v.s. Industry average	13](#_heading=h.92y22j34znus)
...
## <A NAME="_HEADING=H.1HS2NAMCO7TT"></A>2.1 AUTOMOTIVE
...
| - | - | - | - |
|General Motors|157|9\.8|6\.25%|
|Mercedes-Benz|165|9\.4|5\.67%|
|Volkswagen|308|15\.8|5\.13%|
|Ford|158|7\.8|4\.93%|
|Honda|129|6\.3|4\.87%|
|BMW|157|7\.3|4\.64%|
|Renault|51|2\.3|4\.58%|
|Tesla|81|3\.1|3\.77%|
|Toyota|297|8\.9|3\.02%|
|Stellantis|198|5\.7|2\.90%|
|Nissan |81|2\.3|2\.88%|
|Hyundai|143|2\.5|1\.75%|
...
## <A NAME="_HEADING=H.6FL2C7PHN3RE"></A>7.1 COMPETITIVE ADVANTAGES
...
## <A NAME="_HEADING=H.8TJVIO4UC068"></A>7.2 COMPETITIVE DISADVANTAGES
...
1. # <a name="_heading=h.1bvwl0xsisug"></a>Financial performance and forecast
...
## <A NAME="_HEADING=H.92Y22J34ZNUS"></A>9.4 MULTIPLES V.S. INDUSTRY AVERAGE
...
10. # <a name="_heading=h.smft4i4n75gb"></a>Appendix
